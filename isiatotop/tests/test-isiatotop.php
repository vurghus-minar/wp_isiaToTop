...
class IsiatotopTest extends WP_UnitTestCase {
    ...
    public function test_config_array(){
        ...
        $this->assertEquals('http://example.org/wp-content/plugins/C:/xampp/htdocs/php/wordpress/dev/wp-content/plugins/isiatotop/tests/assets/public/css/', $this->class_instance->config->frontend_url->style);
    }
